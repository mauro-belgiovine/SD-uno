...
public class TestGame{
    ...
    static int n_player = 2;
    static int p_turn = 0;

    static int max_n_player;
    
    static Color extra_col;
    ...
    static public int nextPlayer(){
        
        int p_next;
        
        if(!reverse) p_next = (p_turn + 1)% n_player;
        else{
            if(p_turn == 0) p_next = n_player-1;
    ...
    static public void execEffect(Action a){ //apply effect
    ...
    public static void main(String[] args){
        ...
        /*
        // ---> DEBUG: prints all the cards
        for(int i = 0; i < deck.n_cards; i++){
            System.out.print("Card "+i+ " -> ");
            deck.cards[i].printCard();
        }
        System.out.println("Total cards: "+deck.cards.length);
        */
        ...
        players.add(p0); players.add(p1); /*players.add(p2); players.add(p3);
